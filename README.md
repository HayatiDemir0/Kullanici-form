# 🌟 Kullanici-form Projesi

Bu proje, **HTML, CSS ve JavaScript** kullanılarak geliştirilmiş bir **Kayıt Formu** uygulamasıdır.  
Form verileri, **MockAPI** aracılığıyla gönderilip işlenebilir.  

Kullanıcılar formu doldurduğunda:
- Ad, soyad, email, telefon, şifre ve cinsiyet bilgileri alınır
- Şifre doğrulama kontrolü yapılır
- Veri **MockAPI** üzerinden gönderilir ve başarı mesajı gösterilir
...
- 🔹 Ad, Soyad, Email, Telefon, Şifre ve Cinsiyet bilgilerini alma  
